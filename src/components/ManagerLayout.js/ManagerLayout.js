      ...
      >
        <div className="h-20 flex items-center px-6 border-b border-gray-100 shrink-0 relative">
          {user.Restaurant?.logo ? (
            <div className="w-full flex items-center justify-center">
              <img src={formatAssetUrl(user.Restaurant.logo)} alt="Logo" className="max-h-12 max-w-[200px] object-contain" />
            </div>
          ) : (
            <>
        ...
        <div className="p-4 border-t border-gray-100 bg-gray-50/50 shrink-0">
          ...
          <div className="mt-6 flex items-center justify-center gap-2 opacity-80">
            <img src="/logocerta1.png" alt="OrdenGo" className="h-8 object-contain" />
          </div>
        </div>
      </aside>
