                  ...
                  <div className="flex justify-between">
                    <div>
                      ...
                      <h3 className="text-3xl font-bold text-gray-900 mt-1">
                        {new Intl.NumberFormat(currency === 'BRL' ? 'pt-BR' : 'es-ES', { style: 'currency', currency: currency || 'EUR' }).format(data.cards.sales.current)}
                      </h3>
                    </div>
                    <div className="text-right">
                ...
                <CardContent className="p-6">
                  <div className="flex justify-between">
                    <div>
                      ...
                      <h3 className="text-3xl font-bold text-gray-900 mt-1">
                        {new Intl.NumberFormat(currency === 'BRL' ? 'pt-BR' : 'es-ES', { style: 'currency', currency: currency || 'EUR' }).format(data.cards.ticket.current)}
                      </h3>
                    </div>
                    <div className="text-right">
